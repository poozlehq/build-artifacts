  ...
  if (!t && !1 !== t) {
    const e = (function (e) {
      ...
      if (
        ((a = a.split(":", 1)[0]),
        !(function (e, n) {
          var a = (Un("npm_config_no_proxy") || Un("no_proxy")).toLowerCase();
          return (
            !a ||
            ("*" !== a &&
              a.split(/[,\s]/).every(function (a) {
                ...
                return (
                  !(!i || i === n) ||
                  (/^[.*]/.test(o)
                    ? ("*" === o.charAt(0) && (o = o.slice(1)), !zn.call(e, o))
                    : e !== o)
                );
              }))
          );
...
var Tt = function e(n) {
  ...
  zt = Pt.call(Function.call, String.prototype.replace),
  Ut = Pt.call(Function.call, String.prototype.slice),
  Nt = Pt.call(Function.call, RegExp.prototype.exec),
  qt =
    /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
  Dt = /\\(\\)?/g,
  It = function (e, n) {
  ...
  Mt = function (e, n) {
    ...
    var a = (function (e) {
        ...
        var t = [];
        return (
          zt(e, qt, function (e, n, a, o) {
            t[t.length] = a ? zt(o, Dt, "$1") : n || e;
          }),
          t
        );
      })(e),
...
function qo(e, n) {
  if (e.length > n.maxStringLength) {
    ...
    return qo(po.call(e, 0, n.maxStringLength), n) + t;
  }
  return To(
...
function Wo(e, n) {
  ...
  if (a) {
    t.length = e.length;
    for (var o = 0; o < e.length; o++) t[o] = zo(e, o) ? n(e[o], e) : "";
  }
  var i,
...
var Go,
  ...
  Ko = function e(n, a, t, o) {
    ...
    var s = !zo(i, "customInspect") || i.customInspect;
    ...
    if (zo(i, "numericSeparator") && "boolean" != typeof i.numericSeparator)
      throw new TypeError(
    ...
    if ("string" == typeof n) return qo(n, i);
    if ("number" == typeof n) {
    ...
    function d(n, a, s) {
      if ((a && (o = vo.call(o)).push(a), s)) {
        var r = { depth: i.depth };
        return (
          zo(i, "quoteStyle") && (r.quoteStyle = i.quoteStyle),
          e(n, r, t + 1, o)
        );
      }
      return e(n, i, t + 1, o);
...
const { toString: Bi } = Object.prototype,
  { getPrototypeOf: zi } = Object,
  Ui =
    ((Ni = Object.create(null)),
    (e) => {
      const n = Bi.call(e);
      return Ni[n] || (Ni[n] = n.slice(8, -1).toLowerCase());
    });
var Ni;
const qi = (e) => ((e = e.toLowerCase()), (n) => Ui(n) === e),
  Di = (e) => (n) => typeof n === e,
  { isArray: Ii } = Array,
  Mi = Di("undefined");
const $i = qi("ArrayBuffer");
const Hi = Di("string"),
  Wi = Di("function"),
  Gi = Di("number"),
...
const as =
  ...
  ts = (e) => !Mi(e) && e !== as;
const os =
  ((is = "undefined" != typeof Uint8Array && zi(Uint8Array)),
  (e) => is && e instanceof is);
var is;
const ss = qi("HTMLFormElement"),
  rs = (
    ({ hasOwnProperty: e }) =>
    (n, a) =>
      e.call(n, a)
...
function Ns(e) {
  return !1 === e || null == e ? e : fs.isArray(e) ? e.map(Ns) : String(e);
}
function qs(e, n, a, t, o) {
...
class Ds {
  ...
  delete(e, n) {
    ...
    function o(e) {
      if ((e = Us(e))) {
        ...
        !o || (n && !qs(0, a[o], o, n)) || (delete a[o], (t = !0));
      }
    }
  ...
  clear(e) {
    ...
    for (; a--; ) {
      const o = n[a];
      (e && !qs(0, this[o], o, e, !0)) || (delete this[o], (t = !0));
    }
    return t;
  }
  normalize(e) {
    ...
    return (
      fs.forEach(this, (t, o) => {
        ...
        if (i) return (n[i] = Ns(t)), void delete n[o];
        const s = e
          ? (function (e) {
              return e
                .trim()
...
var Or = qr("ERR_INVALID_URL", "Invalid URL", TypeError),
  Tr = qr("ERR_FR_REDIRECTION_FAILURE", "Redirected request failed"),
  Ar = qr("ERR_FR_TOO_MANY_REDIRECTS", "Maximum number of redirects exceeded"),
  Pr = qr(
    "ERR_FR_MAX_BODY_LENGTH_EXCEEDED",
    "Request body larger than maxBodyLength limit"
  ),
  Fr = qr("ERR_STREAM_WRITE_AFTER_END", "write after end");
function Lr(e, n) {
  Er.call(this),
    this._sanitizeOptions(e),
    (this._options = e),
  ...
  (Lr.prototype._processResponse = function (e) {
    ...
    if (
      ...
      (((301 === n || 302 === n) && "POST" === this._options.method) ||
        ...
        ((this._options.method = "GET"),
        (this._requestBodyBuffers = []),
        Nr(/^content-/i, this._options.headers));
      var s,
        r = Nr(/^host$/i, this._options.headers),
      ...
      if (
        ...
        ((u.protocol !== c.protocol && "https:" !== u.protocol) ||
          ...
          Nr(/^(?:authorization|cookie)$/i, this._options.headers),
        Mr(o))
      ) {
        var d = { headers: e.headers, statusCode: n },
          m = { url: l, method: i, headers: t };
...
(Uc.Axios = Pc),
  ...
  (Uc.mergeConfig = Cc),
  (Uc.AxiosHeaders = Is),
  (Uc.formToJSON = (e) => As(fs.isHTMLForm(e) ? new FormData(e) : e)),
...
class $c extends Pi {
  async fetchSingleCollection(e, n) {
    try {
      return { data: Mc((await Nc({ url: e, headers: n })).data) };
    } catch (e) {
      throw new Error(e);
    }
  }
...
class Hc extends Pi {
  async run(e, n, a, t) {
    const o = a.queryParams?.cursor ? parseInt(a.queryParams?.cursor) : 1,
      ...
      s = await Nc({ url: `${Dc}/orgs/${t.org}/repos`, headers: n, params: i });
    return {
...
class Gc extends Pi {
  async fetchSingleComment(e, n, a) {
    return { data: Wc((await Nc({ url: e, headers: n })).data) };
  }
  async patchComment(e, n, a) {
    return {
      data: Wc((await Nc.patch(e, a.requestBody, { headers: n })).data),
    };
  }
  async run(e, n, a, t) {
    const o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/issues/comments/${a.pathParams?.comment_id}`;
    switch (e) {
      case "GET":
...
class Jc extends Pi {
  async fetchData(e, n, a) {
    const t = a.queryParams?.cursor ? parseInt(a.queryParams?.cursor) : 1,
      ...
      s = await Nc({ url: e, headers: n, params: i });
    let r = [];
    return (
  ...
  async createComment(e, n, a) {
    return { data: Wc((await Nc.post(e, a.requestBody, { headers: n })).data) };
  }
  async run(e, n, a, t) {
    let o = "";
    switch (e) {
      case "GET":
      case a.pathParams?.collection_id:
      case a.pathParams?.ticket_id:
        return (
          (o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/issues/${a.pathParams?.ticket_id}/comments`),
      ...
      default:
        return (
          (o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/issues/comments`),
          this.fetchData(o, n, a)
        );
    }
  }
...
class Qc extends Pi {
  async getTag(e, n, a) {
    return { data: Vc((await Nc({ url: e, headers: n })).data) };
  }
  async updateTag(e, n, a) {
    const t = a.requestBody,
      o = ye(t, Kc);
    return { data: Vc((await Nc.patch(e, o, { headers: n })).data) };
  }
  async run(e, n, a, t) {
    const o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/labels/${a.pathParams?.tag_name}`;
    switch (e) {
      case "GET":
...
class Yc extends Pi {
  async getTags(e, n, a) {
    const t = a.queryParams?.cursor ? parseInt(a.queryParams?.cursor) : 1,
      ...
      i = await Nc({ url: e, headers: n, params: o });
    return {
  ...
  async createTag(e, n, a) {
    const t = a.requestBody,
      o = ye(t, Kc);
    return { data: Vc((await Nc.post(e, o, { headers: n })).data) };
  }
  async run(e, n, a, t) {
    const o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/labels`;
    switch (e) {
      case "GET":
...
class ep extends Pi {
  async getTeam(e, n, a) {
    return { data: Xc((await Nc({ url: e, headers: n })).data) };
  }
  async updateTeam(e, n, a) {
    const t = a.requestBody,
      o = ye(t, Zc);
    return { data: Xc((await Nc.patch(e, o, { headers: n })).data) };
  }
  async run(e, n, a, t) {
...
class np extends Pi {
  ...
  async createTeams(e, n, a) {
    const t = a.requestBody,
      o = ye(t, Zc);
    return { data: Xc((await Nc.post(e, o, { headers: n })).data) };
  }
  async run(e, n, a, t) {
...
class op extends Pi {
  ...
  async patchTicket(e, n, a) {
    ...
    return {
      data: ap(
        (await Nc.patch(e, o, { headers: n })).data,
        a.pathParams?.collection_id
      ),
    };
  }
  async run(e, n, a, t) {
    const o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/issues/${a.pathParams?.ticket_id}`;
    switch (e) {
      case "GET":
...
class ip extends Pi {
  async fetchData(e, n, a) {
    const t = a.queryParams?.cursor ? parseInt(a.queryParams?.cursor) : 1,
      o = a.queryParams.limit ?? 10,
      i = { per_page: o, since: a.queryParams?.created_after, page: t },
      s = await Nc({ url: e, headers: n, params: i });
    return {
      data: s.data.map((e) => ap(e, a.pathParams?.collection_id)),
      meta: Ic(s.data, o, t),
    };
  }
  async createTicket(e, n, a) {
    ...
    return {
      data: ap(
        (await Nc.post(e, o, { headers: n })).data,
        a.pathParams?.collection_id
      ),
    };
  }
  async run(e, n, a, t) {
    const o = `${Dc}/repos/${t.org}/${a.pathParams?.collection_id}/issues`;
    switch (e) {
      case "GET":
...
class rp extends Pi {
  async fetchSingleUser(e, n) {
    return {
      data: sp(
        (await Nc({ url: `${Dc}/users/${n.pathParams?.user_id}`, headers: e }))
          .data
      ),
    };
  }
...
class cp extends Pi {
  async getUsers(e, n, a) {
    const t = n.queryParams?.cursor ? parseInt(n.queryParams?.cursor) : 1,
      ...
      i = await Nc({
        url: `${Dc}/repos/${a.org}/${n.pathParams?.collection_id}/assignees`,
        headers: e,
        params: o,
      });
    return {
...
class lp extends Fi {
  ...
  async check(e) {
    try {
      const n = await this.authHeaders(e);
      return (
        await Nc({ url: "https://api.github.com/user", headers: n }),
        { status: !0, error: "" }
      );
    } catch (e) {
  ...
  paths() {
    return [
      new qc(/^\/?proxy$/g, ["GET", "POST", "PATCH", "DELETE"]),
