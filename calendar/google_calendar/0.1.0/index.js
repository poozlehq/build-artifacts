...
K.inherits(se, J),
  ...
  (se.prototype.submit = function (e, n) {
    ...
    return (
      ...
      (a = "https:" == t.protocol ? Z.request(t) : Y.request(t)),
      this.getLength(
        function (e, t) {
...
function cn(e, n, a) {
  ...
  if (!Xe.isFunction(o)) throw new TypeError("visitor must be a function");
  function c(e) {
    if (null === e) return "";
  ...
  return (
    (function e(a, t) {
      if (!Xe.isUndefined(a)) {
        ...
        l.push(a),
          Xe.forEach(a, function (a, i) {
            !0 ===
              (!(Xe.isUndefined(a) || null === a) &&
                o.call(n, a, Xe.isString(i) ? i.trim() : i, t, u)) &&
              e(a, t ? t.concat(i) : [i]);
          }),
          l.pop();
      }
...
function vn(e) {
  function n(e, a, t, o) {
    ...
    const s = Number.isFinite(+i),
      r = o >= e.length;
    return (
      (i = !i && Xe.isArray(t) ? t.length : i),
      r
        ? (Xe.hasOwnProp(t, i) ? (t[i] = [t[i], a]) : (t[i] = a), !s)
        : ((t[i] && Xe.isObject(t[i])) || (t[i] = []),
          n(e, a, t[i], o) &&
            Xe.isArray(t[i]) &&
            (t[i] = (function (e) {
              const n = {},
    ...
    transformRequest: [
      function (e, n) {
        ...
        if (o) {
          ...
          if ((i = Xe.isFileList(e)) || a.indexOf("multipart/form-data") > -1) {
...
function jn(e) {
  return !1 === e || null == e ? e : Xe.isArray(e) ? e.map(jn) : String(e);
}
function En(e, n, a, t) {
...
class Cn {
  ...
  set(e, n, a) {
    ...
    function o(e, n, a) {
      ...
      const i = Xe.findKey(t, o);
      (!i || void 0 === t[i] || !0 === a || (void 0 === a && !1 !== t[i])) &&
        (t[i || n] = jn(e));
    }
    const i = (e, n) => Xe.forEach(e, (e, a) => o(e, a, n));
    return (
  ...
  delete(e, n) {
    ...
    function o(e) {
      if ((e = kn(e))) {
        const o = Xe.findKey(a, e);
        !o || (n && !En(0, a[o], o, n)) || (delete a[o], (t = !0));
      }
    }
    return Xe.isArray(e) ? e.forEach(o) : o(e), t;
  }
  clear(e) {
...
var Va =
    ...
    function (a) {
      return new Promise(async function (i, s) {
        ...
        if (Xe.isSpecCompliantForm(r)) {
          ...
          r = ((e, a, t) => {
            const {
              ...
              size: i = 25,
              boundary: s = o + "-" + Xe.generateString(i, Ta),
            } = t || {};
            if (!Xe.isFormData(e))
        ...
        const F = Xe.toFiniteNumber(C.getContentLength());
        let P, L;
        Xe.isArray(O) ? ((A = O[0]), (T = O[1])) : (A = T = O),
          r &&
            (S || A) &&
            (Xe.isStream(r) || (r = n.Readable.from(r, { objectMode: !1 })),
            (r = n.pipeline(
              [r, new Sa({ length: F, maxRate: Xe.toFiniteNumber(A) })],
              Xe.noop
            )),
            S &&
              r.on("progress", (e) => {
        ...
        if (
          ...
          (h = N.request(B, function (e) {
            ...
            i = t.length > 1 ? n.pipeline(t, Xe.noop) : t[0];
      ...
      return new Promise(function (n, a) {
        ...
        void 0 === t && o.setContentType(null),
          "setRequestHeader" in c &&
            Xe.forEach(o.toJSON(), function (e, n) {
...
function Xa(e) {
  return (
    ...
    ((e) => {
      ...
      for (
        let o = 0;
        o < n && ((a = e[o]), !(t = Xe.isString(a) ? Ya[a.toLowerCase()] : a));
        o++
      );
      if (!t) {
        if (!1 === t)
...
class st {
  ...
  request(e, n) {
    ...
    void 0 !== a &&
      ...
      (i = o && Xe.merge(o.common, o[n.method])),
      i &&
        Xe.forEach(
...
var wt = function () {
  ...
  Et = {},
  Ct = "undefined" == typeof Uint8Array ? mt : jt(Uint8Array),
  Rt = {
    "%AggregateError%":
...
var Ht = It,
  ...
  Zt =
    Object.getOwnPropertyDescriptor && Yt
      ...
      : null,
  Xt = Yt && Zt && "function" == typeof Zt.get ? Zt.get : null,
...
function Uo(e, n) {
  ...
  return Oo(
    po.call(po.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, Do),
    "single",
    n
  );
}
...
var Wo,
  ...
  Ko = function e(n, a, t, o) {
    ...
    if (void 0 === o) o = [];
    else if (zo(o, n) >= 0) return "[Circular]";
    function d(n, a, s) {
    ...
    if (Po(n)) {
      var h = wo
        ...
        : yo.call(n);
      return "object" != typeof n || wo ? h : qo(h);
    }
    if (
      (function (e) {
        return (
    ...
    if (To(n)) {
      ...
      return u &&
        !(function (e) {
          for (var n = 0; n < e.length; n++) if (zo(e[n], "\n") >= 0) return !1;
          return !0;
        })(g)
        ? "[" + Ho(g, u) + "]"
        : "[ " + ho.call(g, ", ") + " ]";
    ...
    if ("object" == typeof n && s) {
      if (So && "function" == typeof n[So] && Co)
        return Co(n, { depth: l - t });
  ...
  Si = function e(n, a, t, o, i, s, r, c, p, l, u, d, m, f, h, x) {
    ...
    for (
      var C = o && wi(b) && 1 === b.length ? a + "[]" : a, R = 0;
      R < k.length;
      ++R
    ) {
      var S = k[R],
...
var Ui;
const Di = (e) => ((e = e.toLowerCase()), (n) => zi(n) === e),
  qi = (e) => (n) => typeof n === e,
  { isArray: Ii } = Array,
  Mi = qi("undefined");
const Hi = Di("ArrayBuffer");
const $i = qi("string"),
  Wi = qi("function"),
  Gi = qi("number"),
...
const as =
  ...
  ts = (e) => !Mi(e) && e !== as;
const os =
  ((is = "undefined" != typeof Uint8Array && Ni(Uint8Array)),
  (e) => is && e instanceof is);
var is;
const ss = Di("HTMLFormElement"),
  rs = (
    ({ hasOwnProperty: e }) =>
    (n, a) =>
      e.call(n, a)
...
var fs = {
  ...
  isAsyncFn: ms,
  isThenable: (e) => e && (Vi(e) || Wi(e)) && Wi(e.then) && Wi(e.catch),
};
...
const Ps = {
  ...
  transformRequest: [
    function (e, n) {
      ...
      if (fs.isFormData(e)) return t && t ? JSON.stringify(Ts(e)) : e;
      if (
        fs.isArrayBuffer(e) ||
        fs.isBuffer(e) ||
        fs.isStream(e) ||
      ...
      if (o) {
        if (a.indexOf("application/x-www-form-urlencoded") > -1)
          return (function (e, n) {
            return _s(
              e,
              new As.classes.URLSearchParams(),
              Object.assign(
                {
                  visitor: function (e, n, a, t) {
  ...
  maxContentLength: -1,
  maxBodyLength: -1,
  env: { FormData: As.classes.FormData, Blob: As.classes.Blob },
  validateStatus: function (e) {
    return e >= 200 && e < 300;
  },
  headers: { common: { Accept: "application/json, text/plain, */*" } },
...
fs.inherits($s, hs, { __CANCEL__: !0 });
var Vs = i.parse,
  Js = { ftp: 21, gopher: 70, http: 80, https: 443, ws: 80, wss: 443 },
  Ks =
    String.prototype.endsWith ||
    function (e) {
      return (
...
var Ys,
  ...
  er = function (e) {
    ...
    if (
      ...
      })((t = t.replace(/:\d*$/, "")), (o = parseInt(o) || Js[a] || 0)))
    )
      return "";
    var i =
...
var yr = i,
  ...
  Rr = ["abort", "aborted", "connect", "error", "socket", "timeout"],
...
var Or = Dr("ERR_INVALID_URL", "Invalid URL", TypeError),
  Ar = Dr("ERR_FR_REDIRECTION_FAILURE", "Redirected request failed"),
  Tr = Dr("ERR_FR_TOO_MANY_REDIRECTS", "Maximum number of redirects exceeded"),
  Fr = Dr(
    "ERR_FR_MAX_BODY_LENGTH_EXCEEDED",
    "Request body larger than maxBodyLength limit"
  ),
  Pr = Dr("ERR_STREAM_WRITE_AFTER_END", "write after end");
function Lr(e, n) {
  jr.call(this),
    this._sanitizeOptions(e),
    (this._options = e),
        ...
        request: {
          value: function (e, t, i) {
            ...
            return (
              ...
              Er.equal(t.protocol, o, "protocol mismatch"),
              Cr("options", t),
              new Lr(t, i)
            );
          },
...
function qr(e) {
  for (var n of Rr) e.removeListener(n, Sr[n]);
...
(Lr.prototype = Object.create(jr.prototype)),
  (Lr.prototype.abort = function () {
    qr(this._currentRequest), this.emit("abort");
  }),
  (Lr.prototype.write = function (e, n, a) {
    if (this._ending) throw new Pr();
      ...
      0 !== e.length
        ? this._requestBodyLength + e.length <= this._options.maxBodyLength
          ? ((this._requestBodyLength += e.length),
            this._requestBodyBuffers.push({ data: e, encoding: n }),
            this._currentRequest.write(e, n, a))
          : (this.emit("error", new Fr()), this.abort())
        : a && a();
  }),
  ...
  (Lr.prototype._performRequest = function () {
    ...
    if (n) {
      ...
      for (var o of ((t._redirectable = this), Rr)) t.on(o, Sr[o]);
      if (
        ((this._currentUrl = /^\//.test(this._options.path)
  ...
  (Lr.prototype._processResponse = function (e) {
    ...
    if (
      (qr(this._currentRequest),
      e.destroy(),
      ++this._redirectCount > this._options.maxRedirects)
    )
      this.emit("error", new Tr());
    else {
      var t,
        o = this._options.beforeRedirect;
      o &&
      ...
      try {
        ...
        return void this.emit("error", new Ar({ cause: e }));
      }
      ...
      try {
        ...
        this.emit("error", new Ar({ cause: e }));
      }
    }
  }),
...
const Zr = fs.ALPHABET.ALPHA_DIGIT + "-_",
  Xr = new e.TextEncoder(),
  ec = "\r\n",
  nc = Xr.encode(ec);
class ac {
  constructor(e, n) {
    ...
    t
      ? (n = Xr.encode(String(n).replace(/\r?\n|\r\n?/g, ec)))
      : (o += `Content-Type: ${n.type || "application/octet-stream"}${ec}`),
      (this.headers = Xr.encode(o + ec)),
      (this.contentLength = t ? n.byteLength : n.size),
      (this.size = this.headers.byteLength + this.contentLength + 2),
      (this.name = e),
      (this.value = n);
    ...
    function (a) {
      return (
        (i = async function (i, s, r) {
          ...
          function w(e) {
            g.emit("abort", !e || e.type ? new $s(null, a, v) : e);
          }
          r((e, n) => {
            (x = !0), n && ((b = !0), y());
          }),
          ...
          if ("data:" === j) {
            ...
            try {
              e = (function (e, n, a) {
                const t = (a && a.Blob) || As.classes.Blob,
                  o = $r(e);
                if ((void 0 === n && t && (n = !0), "data" === o)) {
                  e = o.length ? e.slice(o.length + 1) : e;
                  const a = Wr.exec(e);
          ...
          if (-1 === mc.indexOf(j))
            return s(
              new hs("Unsupported protocol " + j, hs.ERR_BAD_REQUEST, a)
            );
          const E = Is.from(a.headers).normalize();
          E.set("User-Agent", "axios/" + Hr, !1);
          ...
          const T = fs.toFiniteNumber(E.getContentLength());
          let F, P;
          fs.isArray(S) ? ((O = S[0]), (A = S[1])) : (O = A = S),
            c &&
              (R || O) &&
              (fs.isStream(c) || (c = n.Readable.from(c, { objectMode: !1 })),
              (c = n.pipeline(
                [c, new Kr({ length: T, maxRate: fs.toFiniteNumber(O) })],
                fs.noop
              )),
              R &&
                c.on("progress", (e) => {
          ...
          try {
            P = Rs(k.pathname + k.search, a.params, a.paramsSerializer).replace(
              /^\?/,
              ""
            );
          } catch (e) {
          ...
          if (fs.isStream(c)) {
            ...
            c.on("end", () => {
              ...
              c.on("close", () => {
                e || n || w(new $s("Request stream has been aborted", a, v));
              }),
              c.pipe(v);
          } else v.end(c);
        }),
  ...
  xhr:
    ...
    function (e) {
      return new Promise(function (n, a) {
        ...
        fs.isFormData(t) &&
          (As.isStandardBrowserEnv || As.isStandardBrowserWebWorkerEnv
            ? o.setContentType(!1)
        ...
        if (
          (c.open(
            e.method.toUpperCase(),
            Rs(p, e.params, e.paramsSerializer),
            !0
          ),
          (c.timeout = e.timeout),
          "onloadend" in c
...
const Ec = (e) => (e instanceof Is ? e.toJSON() : e);
function Cc(e, n) {
  n = n || {};
  const a = {};
  function t(e, n, a) {
...
const Sc = {};
Rc.transitional = function (e, n, a) {
  function t(e, n) {
    return (
...
const Ac = Oc.validators;
class Tc {
  constructor(e) {
    (this.defaults = e),
      (this.interceptors = { request: new Ss(), response: new Ss() });
  }
  request(e, n) {
    "string" == typeof e ? ((n = n || {}).url = e) : (n = e || {}),
    ...
    void 0 !== a &&
      Oc.assertOptions(
        a,
        {
          silentJSONParsing: Ac.transitional(Ac.boolean),
          forcedJSONParsing: Ac.transitional(Ac.boolean),
          clarifyTimeoutError: Ac.transitional(Ac.boolean),
        },
        !1
      ),
      null != t &&
        (fs.isFunction(t)
          ...
          : Oc.assertOptions(
              t,
              { encode: Ac.function, serialize: Ac.function },
              !0
            )),
      (n.method = (n.method || this.defaults.method || "get").toLowerCase()),
...
fs.forEach(["delete", "get", "head", "options"], function (e) {
  ...
  fs.forEach(["post", "put", "patch"], function (e) {
    ...
    (Tc.prototype[e] = n()), (Tc.prototype[e + "Form"] = n(!0));
  });
var Fc = Tc;
class Pc {
  constructor(e) {
    ...
    this.promise.then((e) => {
      ...
      e(function (e, t, o) {
        a.reason || ((a.reason = new $s(e, t, o)), n(a.reason));
      });
  }
  throwIfRequested() {
    if (this.reason) throw this.reason;
...
const zc = (function e(n) {
  const a = new Fc(n),
    t = Li(Fc.prototype.request, a);
  return (
    fs.extend(t, Fc.prototype, a, { allOwnKeys: !0 }),
...
(zc.Axios = Fc),
  ...
  (zc.mergeConfig = Cc),
  (zc.AxiosHeaders = Is),
  (zc.formToJSON = (e) => Ts(fs.isHTMLForm(e) ? new FormData(e) : e)),
  (zc.HttpStatusCode = Nc),
  (zc.default = zc);
var Uc = zc;
class Dc extends Fi {
  async run(e, n, a) {
...
const qc = "https://www.googleapis.com/calendar/v3";
function Ic(e) {
  return (
    (Ic =
      "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
...
function Hc(e) {
  ...
  return e instanceof Date || ("object" === Ic(e) && "[object Date]" === n)
    ? new Date(e.getTime())
...
function Gc(e, n) {
  Mc(2, arguments);
  var a = Hc(e).getTime(),
    t = Hc(n.start).getTime(),
    o = Hc(n.end).getTime();
  if (!(t <= o)) throw new RangeError("Invalid interval");
  return a >= t && a <= o;
}
function Vc(e, n) {
  var a;
  ...
  var t = (function (e) {
    ...
    null !== (a = null == n ? void 0 : n.additionalDigits) && void 0 !== a
      ? a
      : 2
  );
  if (2 !== t && 1 !== t && 0 !== t)
  ...
  var o,
    i = (function (e) {
      var n,
        a = {},
        t = e.split(Jc.dateTimeDelimiter);
      if (t.length > 2) return a;
      /:/.test(t[0])
        ? (n = t[0])
        : ((a.date = t[0]),
          (n = t[1]),
          Jc.timeZoneDelimiter.test(a.date) &&
            ((a.date = e.split(Jc.timeZoneDelimiter)[0]),
            (n = e.substr(a.date.length, e.length))));
      if (n) {
        var o = Jc.timezone.exec(n);
        o
          ? ((a.time = n.replace(o[1], "")), (a.timezone = o[1]))
          : (a.time = n);
      }
      return a;
    })(e);
  if (i.date) {
    ...
    o = (function (e, n) {
      ...
      var p = new Date(0);
      return (function (e, n, a) {
        return n >= 0 && n <= 11 && a >= 1 && a <= (ep[n] || (np(e) ? 29 : 28));
      })(n, i, s) &&
        (function (e, n) {
          return n >= 1 && n <= (np(e) ? 366 : 365);
        })(n, o)
        ? (p.setUTCFullYear(n, i, Math.max(o, s)), p)
        : new Date(NaN);
  ...
  if (
    ...
    ((p = (function (e) {
      ...
      if (
        !(function (e, n, a) {
          if (24 === e) return 0 === n && 0 === a;
          return a >= 0 && a < 60 && n >= 0 && n < 60 && e >= 0 && e < 25;
        })(a, t, o)
      )
        return NaN;
      return a * Wc + t * $c + 1e3 * o;
    })(i.time)),
    isNaN(p))
  )
    return new Date(NaN);
  ...
  return (
    ...
    isNaN(r) ? new Date(NaN) : new Date(c + p + r)
  );
}
var Jc = {
    dateTimeDelimiter: /[T ]/,
...
var ep = [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
function np(e) {
  return e % 400 == 0 || (e % 4 == 0 && e % 100 != 0);
}
async function ap(e, n, a) {
  let t = {
    maxResults: a.queryParams?.limit,
    ...(a.queryParams?.cursor && { pageToken: a.queryParams?.cursor }),
  };
  const o = await Uc({ url: e, headers: n, params: t });
  let i = o.data.items;
  if (o.data?.nextPageToken) {
    a.queryParams.cursor = o.data.nextPageToken;
    const t = await ap(e, n, a);
    i = [...i, ...t];
  }
  return i;
}
function tp(e, n, a) {
  const t = n.map((e) => ({ id: e.id, description: e.summary })),
    o = [];
  return (
    Object.entries(e.calendars).forEach(([e, n]) => {
      const i = n,
        s = t.find((n) => n.id === e);
      i.busy.forEach((n) => {
        o.push({
          ...
          timezone: a.requestBody.timezone,
          start_time: n.start,
          end_time: n.end,
          status: Go.busy,
        });
...
function op(e, n) {
  const a = {
    start: Vc(n.requestBody.start_time),
    end: Vc(n.requestBody.end_time),
  };
  let t = Go.free;
  return (
    Object.entries(e.calendars).forEach(([e, n]) => {
      n.busy.forEach((e) => {
        const n = { start: Vc(e.start), end: Vc(e.end) };
        (Gc(a.start, n) || Gc(a.end, n)) && (t = Go.busy);
      });
    }),
    {
      timezone: n.requestBody.timezone,
      start_time: n.requestBody.start_time,
      end_time: n.requestBody.end_time,
      status: t,
    }
  );
}
class ip extends Fi {
  async fetchAvailabilityMessage(e, n, a) {
    const t = (await ap(`${qc}/users/me/calendarList`, n, a)).map((e) => ({
        id: e.id,
      })),
      o = {
        timeMin: a.requestBody.start_time,
        timeMax: a.requestBody.end_time,
        timeZone: a.requestBody.timezone,
        items: t,
      };
    return { data: op((await Uc.post(e, o, { headers: n })).data, a) };
  }
  async run(e, n, a, t) {
    let o = "";
    if ("POST" === e)
      return (o = `${qc}/freeBusy`), this.fetchAvailabilityMessage(o, n, a);
    throw new Error(`Unknown method ${e}`);
  }
}
class sp extends Fi {
  async fetchFreeBusy(e, n, a) {
    const t = await ap(`${qc}/users/me/calendarList`, n, a),
      o = t.map((e) => ({ id: e.id })),
      i = {
        timeMin: a.requestBody.start_time,
        timeMax: a.requestBody.end_time,
    ...
    return { data: tp((await Uc.post(e, i, { headers: n })).data, t, a) };
  }
  async run(e, n, a, t) {
    let o = "";
    if ("GET" === e) return (o = `${qc}/freeBusy`), this.fetchFreeBusy(o, n, a);
    throw new Error(`Unknown method ${e}`);
  }
}
var rp = {
...
class cp extends Pi {
  ...
  paths() {
    return [
      ...
      new sp(/^\/?free-busy$/g, ["POST"]),
      new ip(/^\/?available$/g, ["POST"]),
    ];
  }
}
