...
function Kc(e) {
  switch (Hc[e.type]) {
    ...
    case Wo.file:
      return "content" in e
        ? e.content?.map((e) => Vc(e.attrs.__fileName, null))
        : [];
    case Wo.toggle:
...
class Zc extends Pi {
  async fetchData(e, n, a) {
    ...
    console.log(o);
    const i = await qc({ url: e, headers: n, params: o });
    return (
      console.log(i.data),
      { data: i.data.results?.map((e) => Yc(e)), meta: Ic(i.data, t) }
    );
  }
  async run(e, n, a, t) {
    let o = "";
    ...
    return (
      console.log(i),
      "GET" === e ? ((o = `${i}/pages`), this.fetchData(o, n, a)) : []
    );
  }
}
var ep = {
