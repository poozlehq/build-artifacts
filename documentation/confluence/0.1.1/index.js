...
class Rn {
  ...
  delete(e, n) {
    ...
    function o(e) {
      if ((e = kn(e))) {
        ...
        !o || (n && !En(0, a[o], o, n)) || (delete a[o], (t = !0));
      }
    }
  ...
  clear(e) {
    ...
    for (; a--; ) {
      const o = n[a];
      (e && !En(0, this[o], o, e)) || (delete this[o], (t = !0));
    }
    return t;
  }
  normalize(e) {
...
function Uo(e, n) {
  if (e.length > n.maxStringLength) {
    ...
    return Uo(co.call(e, 0, n.maxStringLength), n) + t;
  }
  return Oo(
...
var Wo,
  ...
  Ko = function e(n, a, t, o) {
    ...
    if ("string" == typeof n) return Uo(n, i);
    if ("number" == typeof n) {
    ...
    if (void 0 === o) o = [];
    else if (No(o, n) >= 0) return "[Circular]";
    function d(n, a, s) {
    ...
    if (To(n)) {
      ...
      return u &&
        !(function (e) {
          for (var n = 0; n < e.length; n++) if (No(e[n], "\n") >= 0) return !1;
          return !0;
        })(g)
        ? "[" + Ho(g, u) + "]"
        : "[ " + ho.call(g, ", ") + " ]";
    ...
    if ("object" == typeof n && s) {
      if (So && "function" == typeof n[So] && Ro)
        return Ro(n, { depth: l - t });
  ...
  Ci = {},
  Si = function e(n, a, t, o, i, s, r, c, p, l, u, d, m, f, h, x) {
    for (
    ...
    if (
      ...
      if (i) return r && !f ? r(a, Ri.encoder, h, "key", d) : a;
      b = "";
    }
    if (
      "string" == typeof (v = b) ||
      ...
      return r
        ? [
            m(f ? a : r(a, Ri.encoder, h, "key", d)) +
              "=" +
              m(r(b, Ri.encoder, h, "value", d)),
          ]
        : [m(a) + "=" + m(String(b))];
    var k,
      j = [];
    ...
    for (
      var R = o && wi(b) && 1 === b.length ? a + "[]" : a, C = 0;
      C < k.length;
      ++C
    ) {
      var S = k[C],
            ...
            ("function" == typeof e.filter || wi(e.filter)) && (o = e.filter),
            {
              ...
              serializeDate:
                "function" == typeof e.serializeDate
                  ...
                  : Ri.serializeDate,
              skipNulls:
                "boolean" == typeof e.skipNulls ? e.skipNulls : Ri.skipNulls,
              sort: "function" == typeof e.sort ? e.sort : null,
              strictNullHandling:
                "boolean" == typeof e.strictNullHandling
                  ? e.strictNullHandling
                  : Ri.strictNullHandling,
            }
          );
        })(n);
...
var qi;
const Di = (e) => ((e = e.toLowerCase()), (n) => Ui(n) === e),
  Ii = (e) => (n) => typeof n === e,
  { isArray: Mi } = Array,
  Hi = Ii("undefined");
...
const ts =
  ...
  os = (e) => !Hi(e) && e !== ts;
const is =
  ((ss = "undefined" != typeof Uint8Array && Ni(Uint8Array)),
...
var hs = {
  ...
  isAsyncFn: fs,
  isThenable: (e) => e && (Vi(e) || Gi(e)) && Gi(e.then) && Gi(e.catch),
};
        ...
        request: {
          value: function (e, t, i) {
            ...
            return (
              ...
              Rr.equal(t.protocol, o, "protocol mismatch"),
              Cr("options", t),
              new Br(t, i)
            );
          },
...
function Ir(e) {
  for (var n of Sr) e.removeListener(n, Or[n]);
  e.on("error", Nr), e.abort();
}
function Mr(e) {
  return "string" == typeof e || e instanceof String;
}
...
(Br.prototype = Object.create(Er.prototype)),
  ...
  (Br.prototype._performRequest = function () {
    ...
    if (n) {
      ...
      for (var o of ((t._redirectable = this), Sr)) t.on(o, Or[o]);
      if (
        ((this._currentUrl = /^\//.test(this._options.path)
  ...
  (tr.exports = zr({ http: kr, https: jr })),
  (ar.wrap = zr);
const $r = "1.4.0";
function Wr(e) {
  const n = /^([-+\w]{1,25})(:?\/\/|:)/.exec(e);
    ...
    function (a) {
      return (
        (i = async function (i, s, r) {
          ...
          if (-1 === fc.indexOf(j))
            return s(
              new xs("Unsupported protocol " + j, xs.ERR_BAD_REQUEST, a)
            );
          const E = Ms.from(a.headers).normalize();
          E.set("User-Agent", "axios/" + $r, !1);
          ...
          const T = hs.toFiniteNumber(E.getContentLength());
          let F, P;
          hs.isArray(S) ? ((O = S[0]), (A = S[1])) : (O = A = S),
            c &&
              (C || O) &&
          ...
          try {
            P = Ss(k.pathname + k.search, a.params, a.paramsSerializer).replace(
              /^\?/,
              ""
            );
          } catch (e) {
...
const Rc = (e) => (e instanceof Ms ? e.toJSON() : e);
function Cc(e, n) {
  n = n || {};
  const a = {};
  function t(e, n, a) {
...
function Ic(e, n) {
  const a = e._links?.next ? e._links.next.match(/(?<=cursor=)[^&]+/) : "";
  return { previous: "", current: n, next: a ? a[0] : "" };
}
...
const Hc = {
  ...
  bulletList: Wo.bulleted_list_item,
  codeBlock: Wo.code,
  mediaSingle: Wo.file,
  orderedList: Wo.numbered_list_item,
  extension: Wo.unsupported,
  table: Wo.table,
  tableRow: Wo.table_row,
  tableHeader: Wo.table_header,
  tableCell: Wo.table_cell,
  inlineCard: Wo.inline_card,
  text: Wo.text,
  blockCard: Wo.block_card,
  listItem: Wo.list_item,
  nestedExpand: Wo.toggle,
  expand: Wo.toggle,
  heading: Wo.heading_1,
  heading_1: Wo.heading_1,
  heading_2: Wo.heading_2,
  heading_3: Wo.heading_3,
  heading_4: Wo.heading_4,
  heading_5: Wo.heading_5,
  heading_6: Wo.heading_6,
  date: Wo.date,
  blockquote: Wo.quote,
};
function $c(e, n, a) {
  return { id: "", parent_id: "", block_type: e, content: n, children: a };
}
let Wc = 1;
function Gc(e, n, a, t) {
  let o = a ? `${t}_${a}` : (Wc++).toString(),
    i = { ...e, ...(n ? { raw: n } : {}), id: o, parent_id: t ?? null };
  if (i.children) {
    let e = 1;
    i.children = i.children.map((n) => {
      let a = Gc(n, null, e++, o);
      return (a.parent_id = i.id.toString()), a;
    });
  }
  return i;
}
function Jc(e) {
  ...
  let a, t;
  switch (n) {
    case Wo.numbered_list_item:
    case Wo.bulleted_list_item:
      return e.content.map(
        (e) => (
          (a = e.content ? Kc(e.content[0]) : []),
          (t =
            e.content
              ?.slice(1)
              ?.map((e) => Jc(e))
    ...
    case Wo.table:
    case Wo.table_row:
      return (t = e.content?.map((e) => Jc(e)).flat() || []), [$c(n, [], t)];
    case Wo.table_header:
    case Wo.table_cell:
      return (a = e.content.map((e) => Kc(e).flat()).flat()), [$c(n, a, [])];
    case Wo.toggle:
      return (
        (a = Kc(e)),
        (t = e.content?.map((e) => Jc(e)).flat() || []),
        [$c(n, a, t)]
      );
    case Wo.heading_1:
      return [$c(Hc[`${e.type}_${e.attrs.level}`], Kc(e), [])];
    case Wo.unsupported:
      return (t = e.content?.map((e) => Jc(e)).flat() || []), [$c(n, Kc(e), t)];
    case Wo.quote:
      return (a = e.content?.map((e) => Kc(e)).flat() || []), [$c(n, a, [])];
    default:
      return (a = Kc(e)), [$c(n, a, [])];
  }
}
...
function Kc(e) {
  switch (Hc[e.type]) {
      ...
      return "content" in e
        ? e.content?.map((e) => {
            switch (Hc[e.type]) {
              ...
              case Wo.inline_card:
                return Vc(null, e.attrs.url);
              case Wo.date:
                return Vc(e.attrs.timestamp, null);
              default:
                return [];
            }
          })
    ...
    case Wo.file:
      return "content" in e
        ? e.content?.map((e) => Vc(e.attrs.id ?? null, null))
        : [];
    case Wo.toggle:
      return [Vc(e.attrs.title, null)];
    case Wo.numbered_list_item:
    case Wo.bulleted_list_item:
      return (
        e.content?.map((e) => {
          const n =
            e.content?.find((e) => "paragraph" === e.type)?.content || [];
          return {
            annotations: {
              bold: null,
              italic: null,
            ...
            plain_text: n.find((e) => "text" === e.type)?.text || "",
            href: null,
          };
        }) || []
      );
      ...
      return [
        {
          ...
          plain_text: e.attrs.parameters.macroMetadata.title,
          href: null,
        },
      ];
    default:
...
class Qc extends Pi {
  async getBlocks(e, n, a) {
    const t = a.pathParams?.parent_id;
    e += `/${t}`;
    const o = await qc({
        url: e,
        headers: n,
      ...
      i = JSON.parse(o.data.body.atlas_doc_format.value).content;
    let s = [];
    return (
      i.forEach((e) => {
        const n = Jc(e).map((n) => Gc(n, e, void 0, t));
        s = [...s, ...n];
      }),
      { data: s, meta: {} }
    );
  ...
  async run(e, n, a, t) {
    const o = `${await Mc(t, n)}/pages`;
    return "GET" === e ? this.getBlocks(o, n, a) : {};
  }
}
function Yc(e) {
  return {
...
class Xc extends Pi {
  async fetchSinglePage(e, n, a) {
    return { data: Yc((await qc({ url: e, headers: n })).data) };
  }
  async run(e, n, a, t) {
    const o = `${await Mc(t, n)}/pages/${a.pathParams?.page_id}`;
    return "GET" === e ? this.fetchSinglePage(o, n, a) : {};
  }
}
class Zc extends Pi {
  async fetchData(e, n, a) {
    const t = a.queryParams?.cursor ?? "",
      o = {
        ...
        ...(a.queryParams?.title ? { title: a.queryParams?.title } : {}),
        ...(t ? { cursor: t } : {}),
        ...("asc" === a.queryParams?.direction
          ? {
              sort:
    ...
    return { data: i.data.results?.map((e) => Yc(e)), meta: Ic(i.data, t) };
  }
  async run(e, n, a, t) {
    let o = "";
    const i = await Mc(t, n);
    return "GET" === e ? ((o = `${i}/pages`), this.fetchData(o, n, a)) : [];
  }
}
var ep = {
  auth_specification: {
  ...
  async check(e) {
    try {
      const n = await this.authHeaders(e),
        a = await Mc(e, n);
      return (
        await qc({ url: `${a}/pages?limit=1`, headers: n }),
        { status: !0, error: "" }
      );
    } catch (e) {
...
(exports.default = ap), (exports.main = ap);
